...
def balanced(m):
    ...
    if is_planet(m):
        ...
        return balanced(left_end) and balanced(right_end) and torque_right == torque_left
...
def replace_leaf(t, find_value, replace_value):
    ...
    if is_leaf(t) and label(t) == find_value:
        ...
        brc = [replace_leaf(b,find_value,replace_value) for b in branches(t)]
        return tree(label(t),brc)
...
def preorder(t):
    ...
    if branches(t) == []:
        ...
        tree_list = []
        for lower_tree in branches(t):
            tree_list += preorder(lower_tree) 
        return [label(t)] + tree_list
